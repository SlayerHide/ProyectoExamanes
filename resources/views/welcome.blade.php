...
<body>
    <header>
        ...
        <nav>
            ...
            <a href="{{ route('dashboard.administrador') }}" class="dashboard">Inicio Administrador</a>
            @elseif ($rol === 'docente')
            <a href="{{ route('dashboard.docente') }}" class="dashboard">Inicio Docente</a>
            @elseif ($rol === 'alumno')
            <a href="{{ route('dashboard.alumno') }}" class="dashboard">Inicio Alumno</a>
            @else
            <a href="{{ url('/login') }}" class="dashboard">Dashboard</a>
            @endif

            @else
            <a href="{{ route('login') }}" class="login">Entrar</a>
            @if (Route::has('register'))
            <a href="{{ route('register') }}" class="register">Regístrate</a>
            @endif
            @endauth
        </nav>
        @endif
    ...
    <main>
        <div class="left">
            <h1>¡Bienvenido a SmartExam!</h1>
            <p>Gestiona, aplica y evalúa exámenes de forma inteligente.</p>
        </div>
        <div class="right">
            <img src="https://www.mceducation.us/wp-content/uploads/2021/10/answer-keys-banner.jpg" alt="Imagen de bienvenida">
        </div>
    </main>
</body>
